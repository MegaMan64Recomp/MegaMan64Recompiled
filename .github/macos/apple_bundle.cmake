...
set_target_properties(MegaMan64Recompiled PROPERTIES
        MACOSX_BUNDLE TRUE
        MACOSX_BUNDLE_BUNDLE_NAME "MegaMan64Recompiled"
        MACOSX_BUNDLE_GUI_IDENTIFIER "com.github.MegaMan64recompiled"
...
target_sources(MegaMan64Recompiled PRIVATE ${ICNS_FILE})

# Ensure MegaMan64Recompiled depends on create_icns
add_dependencies(MegaMan64Recompiled create_icns)

# Configure Info.plist
configure_file(${CMAKE_SOURCE_DIR}/.github/macos/Info.plist.in ${CMAKE_BINARY_DIR}/Info.plist @ONLY)

# Install the app bundle
install(TARGETS MegaMan64Recompiled BUNDLE DESTINATION .)
...
add_custom_command(TARGET MegaMan64Recompiled POST_BUILD
    ...
    COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_BINARY_DIR}/temp_assets $<TARGET_BUNDLE_DIR:MegaMan64Recompiled>/Contents/Resources/assets
    COMMAND ${CMAKE_COMMAND} -E remove_directory ${CMAKE_BINARY_DIR}/temp_assets

    # Copy controller database
    COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/recompcontrollerdb.txt $<TARGET_BUNDLE_DIR:MegaMan64Recompiled>/Contents/Resources/

    # Set RPATH
    COMMAND install_name_tool -add_rpath "@executable_path/../Frameworks/" $<TARGET_BUNDLE_DIR:MegaMan64Recompiled>/Contents/MacOS/MegaMan64Recompiled

    # Sign the bundle
    COMMAND codesign --verbose=4 --options=runtime --no-strict --sign - --entitlements ${ENTITLEMENTS_FILE} --deep --force $<TARGET_BUNDLE_DIR:MegaMan64Recompiled>
